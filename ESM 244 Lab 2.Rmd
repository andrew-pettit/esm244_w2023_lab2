...
mdl1 <- lm(f1, data = penguins_clean) #literally the same as previous code jsut another way to do it
...
aictab(list(mdl1, mdl2, mdl3)) #sows good evidence that model 2 is the best model 
